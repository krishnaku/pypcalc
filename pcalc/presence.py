...
class PresenceMatrix(Generic[T_Element]):
    """
    A time-binned matrix representation of signal presences on a timeline.
    ...
    def __init__(self, presences: List[Presence[T_Element]], t0: float, t1: float, bin_width: float):
        """
